...
const Footer = ({ links = [], socials = {}, copyright }) => {
  ...
  return (
    <footer className="bg-gradient-to-br from-pink-600 via-purple-600 to-blue-600 text-white py-20 relative overflow-hidden">
      {/* Glow effects */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="border-t border-white/20 mt-16 pt-8 text-center">
          <p className="text-white/60 text-lg">{copyright}</p>
        </div>
      </div>
    </footer>
  );
